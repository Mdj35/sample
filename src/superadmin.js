...
const SuperAdmin = () => {
    ...
    const fetchServices = () => {
        fetch('http://127.0.0.1/getservices.php')
    ...
    const fetchBranches = () => {
        fetch('http://127.0.0.1/getbranches.php')
            .then((response) => response.json())
    ...
    const fetchEmployees = () => {
        fetch('http://127.0.0.1/getadmins.php') // Ensure this endpoint returns the list of employees
            .then((response) => response.json())
    ...
    const fetchPendingUsers = () => {
        fetch('http://127.0.0.1/getpendingusers.php') // Add this endpoint to get pending users
            .then((response) => response.json())
    ...
    const fetchVipUsers = () => {
        fetch('http://127.0.0.1/getvipusers.php') // Add this endpoint to get VIP users
            .then((response) => response.json())
    ...
    const deactivateEmployee = (employeeId) => {
        fetch('http://127.0.0.1/deleteadmin.php', {
            method: 'POST',
            headers: {
    ...
    const activateEmployee = (employeeId) => {
        fetch('http://127.0.0.1/activateadmin.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    const setUserToVIP = (userId) => {
        fetch('http://127.0.0.1/setvip.php', { // Add this endpoint to set user to VIP
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    const handleSubmit = (e) => {
        ...
        fetch('http://127.0.0.1/createadmin.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
