...
import './ProfilePage.css'; // Import your CSS
...
const ProfilePage = () => {
  ...
  const handleVipApplication = async () => {
    try {
      const response = await fetch('https://vynceianoani.helioho.st/updateVipStatus.php', { // New PHP endpoint
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
        ...
        <div className="profile-info">
          {isEditing ? (
            <>
              ...
              <button className="profile-save-button" onClick={handleProfileUpdate}>Save Changes</button>
            </>
          ) : (
            <>
              <div className="profile-row">
              ...
              <div className="profile-row">
    <label>Status:</label>
    {/* Conditionally render the status or VIP badge */}
    {userData.status !== 'VIP' ? (
        ...
        <div className="vip-badge">
            ...
            <p>You are a VIP!</p>
              ...
              {isVipEligible && vipStatus === 'Non-VIP' ? (
                ...
                <div className="vip-note">
                  <p>To unlock VIP status, make at least 5 reservations and spend at least 5,000.</p>
                </div>
              )}
